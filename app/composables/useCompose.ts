...
export function useCompose() {
  ...
  const visibilityLabel = computed(() => {
    switch (visibility.value) {
      case 0: return { label: 'Public', icon: 'IconGlobe', tone: 'badge-success' }
      case 1: return { label: 'Friends', icon: 'IconUsers', tone: 'badge-info' }
      case 2: return { label: 'Unlisted', icon: 'IconEyeOff', tone: 'badge-warning' }
      case 3: return { label: 'Private', icon: 'IconLock', tone: 'badge-neutral' }
      default: return { label: 'Public', icon: 'IconGlobe', tone: 'badge-success' }
    }
  })
