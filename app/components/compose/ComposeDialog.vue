<template>
    <dialog id="compose-dialog" ref="dialogRef" class="modal modal-open">
        ...
        >
            <!-- Header -->
            <div
                class="flex items-center justify-between px-4 py-3 border-b border-base-200 bg-base-100"
            >
                ...
                <div class="p-4 space-y-4">
                    ...
                    >
                        ...
                        <div v-if="publishers.length > 1" class="dropdown">
                            ...
                            <ul
                                class="dropdown-content z-20 menu p-2 shadow-lg bg-base-100 rounded-box w-56 mt-2"
                            >
                                    ...
                                    >
                                        <div class="avatar">
                                            <div class="w-6 h-6 rounded-full">
                                                ...
                                                <div
                                                    v-else
                                                    class="w-full h-full bg-primary text-primary-content flex items-center justify-center text-xs"
                                                >
                                                    {{
                                                        getInitials(
                                                            pub.nick ||
                    ...
                    >
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <span
                                ...
                                >{{ replyingTo.content.slice(0, 100) }}</span
                            >
                        </div>
                    </div>
                    ...
                    >
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <span
                                class="text-sm text-base-content/50 line-clamp-1"
                                >{{ forwardingTo.content.slice(0, 100) }}</span
                            >
                        </div>
                    </div>
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center gap-1">
                        ...
                        <div class="badge badge-ghost gap-1">
                            ...
                            />
                            <IconUsers
                                v-else-if="visibility === 1"
                                class="w-3.5 h-3.5"
                            />
                            <IconEyeOff
                                v-else-if="visibility === 2"
                                class="w-3.5 h-3.5"
                            />
