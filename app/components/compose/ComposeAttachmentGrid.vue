    ...
    <div class="space-y-3">
        ...
        >
            <div
                ...
                :class="{
                    'col-span-2 sm:col-span-2': isLargeAttachment(attachment),
                }"
            >
                <!-- Image Preview -->
                <template v-if="isImage(attachment)">
                    <div class="aspect-video relative">
                        <img
                            v-if="
                                attachment.preview || attachment.cloudFile?.url
                            "
                            :src="
                                attachment.preview || attachment.cloudFile?.url
                            "
                        ...
                        <div
                            ...
                            :class="{
                                'opacity-100': showActions === attachment.id,
                            }"
                        >
                            <button
                                v-if="index > 0"
                ...
                <template v-else-if="isAudio(attachment)">
                    <div
                        class="aspect-video relative bg-linear-to-br from-primary/20 to-secondary/20 flex flex-col items-center justify-center p-4"
                    >
                        <IconMusic class="w-10 h-10 text-primary mb-2" />
                        <p
                            class="text-xs text-center text-base-content/70 truncate w-full"
                        >
                            {{ getFileName(attachment) }}
                        </p>
                ...
                <template v-else>
                    <div
                        class="aspect-video relative bg-base-300 flex flex-col items-center justify-center p-4"
                    >
