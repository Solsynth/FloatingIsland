...
defineOgImage('UniOgImage', { title: computed(() => seoTitle.value || 'Solar Network'), description: computed(() => seoDescription.value || ''), iconImage: computed(() => avatarUrl.value || undefined) })
