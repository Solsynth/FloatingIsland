  ...
  <div class="min-h-screen bg-base-200 flex items-center justify-center px-4">
    <div class="w-full max-w-md">
      <div class="text-center mb-8">
        <div class="inline-flex items-center gap-2 text-3xl font-bold text-primary">
      ...
      <div class="card bg-base-100 shadow-xl">
        <div class="card-body">
          ...
          <div v-if="currentStep === 5" class="space-y-3">
            ...
            <!-- Captcha placeholder - would integrate Cloudflare Turnstile/hCaptcha -->
            <div class="p-4 bg-base-200 rounded text-sm text-center">
...
const canProceed = computed(() => {
  switch (currentStep.value) {
    ...
    case 5: return true // captcha validated
